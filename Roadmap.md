...
## Phase B – Vereinsgründung & Organisation
- Mitgründer finden
- Satzung erstellen
- Verein offiziell gründen & registrieren
- Gemeinnützigkeit beantragen
- Vereinskonto & Kommunikationskanäle einrichten

## Phase C – Makerspace Kamenz (Pilotstandort)
- Räumlichkeiten auswählen und einrichten
- Zonen nach den Skill-Forge-Bereichen strukturieren
...
- Projektbeispiele definieren (einfach → komplex)
...
- Förderprogramme anfragen (Bildung, Digitalisierung, Jugend)
- Mitgliedsbeiträge festlegen
- Sachspenden einwerben

## Phase F – Website & Öffentlichkeitsarbeit
- skill-forge.de/eu aufbauen
- Basisinfos, Kurse, Galerie, Zertifikate
- Social Media starten
- Eröffnungsveranstaltung planen

## Phase G – Weiterentwicklung & Skalierung
